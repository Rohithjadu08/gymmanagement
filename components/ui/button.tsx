...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
        default:
          'bg-emerald-600 text-white shadow-md hover:bg-emerald-500 hover:shadow-emerald-500/20',
        amber:
          'bg-amber-600 text-white shadow-md hover:bg-amber-500 hover:shadow-amber-500/20',
        destructive:
          'bg-rose-600 text-white shadow-md hover:bg-rose-500 hover:shadow-rose-500/20',
        outline:
